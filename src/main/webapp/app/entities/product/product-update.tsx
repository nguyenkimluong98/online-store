  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="bookstoreApp.product.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField label="Size" id="product-size" name="size" data-cy="size" type="select">
                {sizeValues.map(size => (
