...
import com.haui.onlinestore.repository.ProductCategoryRepository;
import com.haui.onlinestore.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link com.haui.onlinestore.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
public class ProductCategoryResource {
    ...
    public ResponseEntity<ProductCategory> partialUpdateProductCategory(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, productCategory.getId())
        );
    }
