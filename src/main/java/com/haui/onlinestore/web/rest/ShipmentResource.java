...
import com.haui.onlinestore.repository.ShipmentRepository;
import com.haui.onlinestore.security.AuthoritiesConstants;
import com.haui.onlinestore.service.ShipmentService;
...
/**
 * REST controller for managing {@link com.haui.onlinestore.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")
public class ShipmentResource {
    ...
    public ResponseEntity<Shipment> updateShipment(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, shipment.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Shipment> partialUpdateShipment(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, shipment.getId())
        );
    }
