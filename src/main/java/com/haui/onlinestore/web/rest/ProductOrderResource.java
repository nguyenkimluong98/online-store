...
import com.haui.onlinestore.service.ProductOrderService;
...
/**
 * REST controller for managing {@link com.haui.onlinestore.domain.ProductOrder}.
 */
@RestController
@RequestMapping("/api")
public class ProductOrderResource {
    ...
    public ResponseEntity<ProductOrder> partialUpdateProductOrder(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, productOrder.getId())
        );
    }
